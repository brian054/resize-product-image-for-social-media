...
# this looks better than camelCase fr (generateJsonFileForImport, hmmm IDK THO)
# Google says snake case is usually used so let's just follow the standard
def generate_json_file_for_import(vendors):
...
generate_json_file_for_import(vendors)
